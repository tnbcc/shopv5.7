                ...
                @if(isset($categoryTree))
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="categoryTree">
                            ...
                            @each('layouts.category_item', $categoryTree, 'category')
                        </ul>
                    </li>
            @endif
            <!-- 顶部类目菜单结束 -->
             ...
             @else
                     ...
                     <li class="nav-item dropdown">
                         <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                             <img src="http://shopv1.work/storage/images/b0556dde14487020a03ccc1ed1c5d106.jpg" class="img-responsive img-circle" width="30px" height="30px">
                             {{ Auth::user()->name }}
                         </a>
